...
# image_to_hand('/home/quan/PycharmProjects/sign-language-gesture-recognition/utils/filename.txt', '/home/quan/PycharmProjects/sign-language-gesture-recognition/data/file_distance_2hand.txt' )
# image_to_hand('/home/quan/PycharmProjects/sign-language-gesture-recognition/utils/filename.txt', '/home/quan/PycharmProjects/sign-language-gesture-recognition/data/file_distance.txt')
img = cv2.imread('/home/quan/PycharmProjects/sign-language-gesture-recognition/data/raw_images_1/001_001_002_frame_2.png')
img = cv2.cvtColor(img, cv2.COLOR_RGB2GRAY)

laplace = cv2.filter2D(img,0,laplacian)
